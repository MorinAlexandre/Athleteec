...
define('DB_NAME',			"athleteec"			); // Database name
...
class Integration{
	...
	function getFriendsList($userid,$time) {
		...
		$sql = ("select DISTINCT ".DB_USERTABLE.".".DB_USERTABLE_USERID." userid, ".DB_USERTABLE.".".DB_USERTABLE_NAME." username,  ".DB_USERTABLE.".photo_id link,  ".DB_USERTABLE.".photo_id  avatar, cometchat_status.lastactivity lastactivity,cometchat_status.lastseen, cometchat_status.lastseensetting, cometchat_status.status, cometchat_status.message, cometchat_status.isdevice from ".DB_USERTABLE." left join cometchat_status on ".DB_USERTABLE.".id = cometchat_status.userid order by username asc"); 
